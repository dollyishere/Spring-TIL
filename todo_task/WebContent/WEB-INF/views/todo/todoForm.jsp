		            ...
		            <div class="custom-form text-center" style="width: 25rem;"> <!-- text-center 클래스 추가 -->
		                <form  method="post"  action="${contextPath}/todo/addTodo.do">
		                    ...
		                    <div class="mb-2 row  justify-content-start align-items-center">
		                        ...
		                        <div class="col-md-auto">
		                        	<input name="todoData" id="editor" class="form-control" maxlength="10"  size="10" required />
		                        </div>
		                    </div>
		                    <!-- 종료일 -->
		                    <div class="mb-2 row  justify-content-start align-items-center">
		                     ...
		                     <div class="mb-2 row  justify-content-start align-items-center">
		                        ...
		                        <div class="col-md-auto">
			                        <select name="importance" class="form-select" >
									  ...
									  <option value="good">중요</option>
									  <option value="average">보통</option>
									  <option value="poor">별로</option>
									</select>
		                        </div>
		                        <div class="col-md-3">
							    </div>
		                    ...
		                    <div class="mb-2 row  justify-content-start align-items-center">
		                        ...
		                        <div class="col-md-auto  row  justify-content-center align-items-center">
			                	 ...
			                	 <input class="form-check-input" type="radio" id="result1" name="result" value="complete" >
					                 <label class="form-check-label" for="result1">
									   	<b>완료</b>
									  </label>
				                </div>
				                <div class="col-md-auto form-check">
					                <input class="form-check-input" type="radio" id="result2" name="result" value="pend" >
					                <label class="form-check-label" for="result2">
									    <b>보류</b>
									  </label>
				                </div>
				                <div class="col-md-auto form-check">
					                <input class="form-check-input" type="radio" id="result3" name="result" value="failure" >
		                    ...
		                    <div class="mb-2 d-flex justify-content-end">
		                        <input type="submit" value="register" class="btn" style="background-color:#D996B5; color:white;" />
		                        &nbsp;
